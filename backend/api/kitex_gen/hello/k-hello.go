...
func (p *HelloHelloArgs) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_HelloHelloArgs[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *HelloHelloArgs) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *HelloHelloArgs) FastWrite(buf []byte) int {
	return 0
}

func (p *HelloHelloArgs) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *HelloHelloArgs) BLength() int {
	l := 0
...
func (p *HelloHelloArgs) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *HelloHelloArgs) field1Length() int {
	l := 0
...
func (p *HelloHelloResult) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_HelloHelloResult[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *HelloHelloResult) FastReadField0(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *HelloHelloResult) FastWrite(buf []byte) int {
	return 0
}

func (p *HelloHelloResult) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *HelloHelloResult) BLength() int {
	l := 0
...
func (p *HelloHelloResult) fastWriteField0(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetSuccess() {
...
func (p *HelloHelloResult) field0Length() int {
	l := 0
	if p.IsSetSuccess() {
...
func (p *HelloHelloArgs) GetFirstArgument() interface{} {
	return p.Req
}

func (p *HelloHelloResult) GetResult() interface{} {
	return p.Success
}
