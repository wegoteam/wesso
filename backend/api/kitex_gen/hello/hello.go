...
func (p *HelloHelloArgs) InitDefault() {
	*p = HelloHelloArgs{}
}
...
func (p *HelloHelloArgs) SetReq(val *Request) {
	p.Req = val
}
...
func (p *HelloHelloArgs) DeepEqual(ano *HelloHelloArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *HelloHelloArgs) Field1DeepEqual(src *Request) bool {
...
func (p *HelloHelloResult) InitDefault() {
	*p = HelloHelloResult{}
}
...
func (p *HelloHelloResult) SetSuccess(x interface{}) {
...
func (p *HelloHelloResult) DeepEqual(ano *HelloHelloResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *HelloHelloResult) Field0DeepEqual(src *Response) bool {
